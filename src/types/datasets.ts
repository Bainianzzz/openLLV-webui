import type { DatasetDownloadTaskDetail, Page, TaskSummary } from "@/types";
...
export type DatasetDownloadTask = Pick<
  TaskSummary,
...
export type DatasetDownloadTaskDetailResponse = Omit<
  DatasetDownloadTaskDetail,
  "job" | "dataset_download"
> & { job?: DatasetDownloadJob; dataset_download?: DatasetDownloadJob };
export type DatasetDownloadTaskDetailView = Omit<
  DatasetDownloadTaskDetail,
  "job" | "dataset_download"
> & { job: DatasetDownloadJob; dataset_download: DatasetDownloadJob };
