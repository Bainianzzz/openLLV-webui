...
const { items, page, total, pageCount, loading, error, loadTasks, setFilters } =
  useTasks();
...
<template>
  <PageHeader
    eyebrow="Activity"
    title="Tasks"
    description="Every enhancement, training, and dataset download is tracked from queue to completion."
  />
  ...
  <Card class="overflow-hidden">
    ...
    <Alert
      v-if="error"
      role="alert"
      class="mx-6 mb-4 border-destructive/30 bg-destructive/5 text-destructive"
    >
        ...
        <Table>
          <TableHeader
            ><TableRow
              ...
              ><TableHead>Message</TableHead><TableHead>Created</TableHead
              ><TableHead>Finished</TableHead
              ><TableHead class="text-right"> </TableHead></TableRow
          ></TableHeader>
          <TableBody>
            ...
            <TableRow v-for="item in items" v-else :key="item.id">
              ...
              <TableCell
                ...
                ></TableCell
              >
              <TableCell class="max-w-72 text-muted-foreground">{{
